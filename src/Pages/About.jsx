  ...
  const features = [
    {
      ...
      description:
        "We curate only the finest tech products from trusted brands worldwide.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Our tech specialists are here to help you find the perfect products.",
    },
  ];
      ...
      <main className="container mx-auto px-4 py-12 ">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-lg">
            Founded in 2020, Shoppie has become the premier destination for
            luxury tech products. We believe technology should enhance your
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-400">
              ...
              marketplace for discerning tech enthusiasts. We partner directly
              with manufacturers to bring you the latest innovations at
              competitive prices.
            </p>
            <p className="text-gray-400">
              Every product in our catalog is hand-picked by our team of experts
              who understand the balance between cutting-edge technology and
              timeless design.
            </p>
          </div>
          <div className="bg-gray-900 p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-400">
              To democratize access to premium technology while maintaining the
              highest standards of quality, service, and customer satisfaction.
